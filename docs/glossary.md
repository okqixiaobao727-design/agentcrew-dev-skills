...
**Wave table** — The routing table (ticket → workflow, executor, model, effort, review lane) the
user approves before the run. After approval it is the sole routing authority.
